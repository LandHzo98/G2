...
public class FormularioClasico {
    ...
    public void initcomponents(){
        ...
        listado.add(new usuario(String.valueOf(new Random().nextInt()), "KatiaVanessa",  "Landaverde", 70079032,LocalDate.of(1980,8,12),'F'));
        listado.add(new usuario(String.valueOf(new Random().nextInt()), "Ernesto Alexander",  "Nochez", 78787878,LocalDate.of(1975,6,15),'M'));
        listado.add(new usuario(String.valueOf(new Random().nextInt()), "Adalberto Erick",  "Lopez", 75487845,LocalDate.of(1975,1,15),'M'));
       listado.add(new usuario(String.valueOf(new Random().nextInt()), "Jose Jose",  "Oliva", 71234567,LocalDate.of(1976,12,31),'M'));
