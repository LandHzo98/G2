...
public class FormularioSteamAPI {
    ...
    public void initcomponents(){
        ...
        if (listadoModel==null){
         ...
         listadoModel.add(new usuario(String.valueOf(new Random().nextInt()), "Ricardo Armando", "Rivera", 70079032, LocalDate.of(1980,8,12),'F'));
        listadoModel.add(new usuario(String.valueOf(new Random().nextInt()), "Carmen lili", "Gonzales", 78787878,LocalDate.of(1975,6,15),'F'));
        listadoModel.add(new usuario(String.valueOf(new Random().nextInt()), "Rene Rigo", "Morales", 75487845,LocalDate.of(1975,1,15),'M'));
        listadoModel.add(new usuario(String.valueOf(new Random().nextInt()), "Pedro Apolinar", "Ascar", 70451245,LocalDate.of(1971,2,15),'M'));
